...
const VIGILADOS = [
  { id: 'persona1', label: 'Ana' },
  { id: 'persona2', label: 'Bea' },
  { id: 'persona3', label: 'Cami' },
  { id: 'yo', label: 'Yo' },
  { id: 'ocio', label: 'Ocio' },
];
...
test('ámbar dentro de la banda de aviso (2 puntos antes del tope)', () => {
  // persona2 (Bea) tope 10% → ámbar desde 8%. 8.5% = 255.000
...
test('respeta los topes por defecto por id (Ana 15%, Bea 10%)', () => {
  // 12% de gasto: Ana (tope 15%) sigue verde/ámbar; Bea (tope 10%) rojo
