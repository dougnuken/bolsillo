...
// v2: agrega el store 'prestamos' (cuentas por cobrar).
// v3: agrega el store 'cortes' (snapshots de extractos: diferidos mes a mes).
// onupgradeneeded crea los stores que falten, así que subir la versión basta
// para sembrarlos en las DB ya existentes sin tocar los datos que ya hay.
const DB_VERSION = 3;
