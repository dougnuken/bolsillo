/* ============================================================
   ...
   87810 · "Banco Occidente informa que realizo Compra por  50,000.00 en
            TIENDA UNO 51Bcon la T Credencial #0000, a las 202536del
            20260730. Linea de servicio"
     · monto ANGLO: la coma es miles y el punto decimales (50,000.00),
   ...
   85722 · "Ud realizo una compra en GIMNASIO DEMO  por $100.000.T.
            Credencial *0000, 2026/04/01, 18:12. Bco. Occidente Linea de
            Servicio (601)3902058"
     · monto COP: el punto es miles ($100.000 son cien mil),
     · el comercio va ANTES del monto, con espacios de sobra,
     · fecha AAAA/MM/DD y hora HH:MM.

   O sea: el MISMO banco escribe 50,000.00 y $100.000 para decir cosas del
   mismo tipo. Por eso cada plantilla trae su propio lector de número en vez
   de una heurística común — parseCOP() leería "50,000.00" como 50 pesos.

   Todo aquí es PURO: se prueba en Node contra SMS de ejemplo (ficticios).
   ============================================================ */
 ...
 * "50,000.00" → 50000 · "1,234,567.89" → 1234568
...
export const PLANTILLAS = Object.freeze([
  Object.freeze({
    ...
    // "…realizo Compra por  50,000.00 en TIENDA UNO 51Bcon la T Credencial #0000, a las 202536del 20260730…"
  ...
  Object.freeze({
    ...
    // "Ud realizo una compra en GIMNASIO DEMO  por $100.000.T. Credencial *0000, 2026/04/01, 18:12…"
 ...
 * $300.000 en SERVICIO DEMO, a las 14:05:45 y a las 14:14:23. Son dos
